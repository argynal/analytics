...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
         items = [
            Bill.objects.get_or_create(name="Socks", price=6.5), Bill.objects.get_or_create(name="Pants", price=12),
            Bill.objects.get_or_create(name="T-Shirt", price=8), Bill.objects.get_or_create(name="Boots", price=9),
            Bill.objects.get_or_create(name="Sweater", price=3), Bill.objects.get_or_create(name="Underwear", price=9),
            Bill.objects.get_or_create(name="Leggings", price=7), Bill.objects.get_or_create(name="Cap", price=5),
        ]
